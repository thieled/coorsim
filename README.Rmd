...
Next we aggregate the observations of coordinated posting behavior on account level. We create a network, where the nodes are accounts and the edge weight is defined by the number of coordinated posting events. Finally, we identify communities of accounts using 'louvain' clustering:
...
```{r plot-1, eval=T, fig.width=12, fig.height=8, dpi=300}
...
```{r plot-2, eval=T, fig.width=12, fig.height=8, dpi=300}
# Plot Communities
