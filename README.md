...
users that engage in *coordinated posting behavior,* which can indicate
manipulative efforts such as “coordinated social media manipulation”
(Thiele et al. 2025). By leveraging embeddings, coorsim allows to detect
*semantically* similar coordinated posting, going beyond existing tools
such as ‘CooRTweet’ (Righetti and Balluff 2025) which is tailored to
detect coordinated sharing of identical objects. This argue that this
approach is relevant for identifying LLM-generated coordinated content.
